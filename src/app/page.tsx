...
const features = [
  ...
  },
  {
    ...
    text: "Видны цена банка, срок и график взносов; вознаграждение банка заложено как маржа, без скрытых условий в интерфейсе.",
  },
  {
    icon: IconScale,
    title: "Сопоставимо с рынком",
    text: "Расчётный параметр графика согласуется с ключевой ставкой — так проще сравнить условия с обычной ипотекой при шариатском оформлении.",
  },
  {
    icon: IconChat,
        ...
        <section className="relative overflow-hidden rounded-[var(--radius-2xl)] border border-[var(--border)] bg-[var(--surface)] p-8 shadow-[var(--shadow-card)] sm:p-10 md:p-12">
          ...
          <div className="relative max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-[var(--text-secondary)] sm:text-lg">
              ...
              заранее видите цену, взносы и срок — в интерфейсе без формулировок «проценты» и «пени»,
