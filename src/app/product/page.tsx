      ...
      <main className="mx-auto max-w-6xl px-4 pb-20 pt-6 sm:px-6 sm:pt-8">
        ...
        <div className="mt-8 max-w-3xl">
          ...
          <p className="mt-3 max-w-3xl text-[var(--muted)] leading-relaxed sm:text-lg">
            Продукт «Ипотека Мурабаха» предназначен для приобретения готового жилья или объекта на
            этапе строительства.
          </p>
          <p className="mt-3 max-w-3xl text-[var(--muted)] leading-relaxed sm:text-lg">
            Сделка оформляется в соответствии с шариатским подходом, что подтверждается{" "}
            <a
          ...
          <p className="mt-3 max-w-3xl text-xs text-[var(--muted)] leading-relaxed sm:text-sm">
            * Фетва разработана и утверждена Духовным управлением мусульман (России, Татарстана, Чечни,
            Дагестана), Международным шариатским советом и Центральным духовным управлением мусульман
            (ЦДУМ).
          </p>
        </div>
          ...
          <div className="mt-6 rounded-[var(--radius-2xl)] border border-[var(--border)] bg-[var(--surface)] p-6 shadow-[var(--shadow-sm)] sm:p-8">
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-10">
              <div>
                ...
                <p className="mt-3 text-[var(--muted)] leading-relaxed">
                  Ниже — укрупнённая схема сделки от подбора объекта до полного погашения.
                </p>
                <ol className="mt-5 space-y-3 text-[var(--muted)] leading-relaxed">
                  ...
                  <li>
                    ...
                    Банк продаёт объект вам по цене с графиком взносов (первоначальный
