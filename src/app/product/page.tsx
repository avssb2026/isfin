      ...
      <main className="mx-auto max-w-6xl px-4 pb-20 pt-6 sm:px-6 sm:pt-8">
        ...
        <div className="mt-8 max-w-3xl">
          ...
          <p className="mt-3 max-w-3xl text-[var(--muted)] leading-relaxed sm:text-lg">
            ...
            соответствии с шариатским подходом, что подтверждается{" "}
            <a
            ...
            : фиксируется цена банка, отсроченная цена для вас и график взносов. Фетва разработана и
            утверждена Духовным управлением мусульман (России,
